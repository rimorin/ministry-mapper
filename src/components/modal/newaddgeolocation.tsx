...
import { NewAddressCoordinatesModalProps } from "../../utils/interface";
...
const NewAddressGeolocation = NiceModal.create(
  ({ coordinates, origin }: NewAddressCoordinatesModalProps) => {
...
export default NewAddressGeolocation;
